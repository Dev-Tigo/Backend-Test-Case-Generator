...
WORKDIR /src
COPY ["Test-Case-Generator.csproj", "."]
RUN dotnet restore "./Test-Case-Generator.csproj"
COPY . .
WORKDIR "/src/."
RUN dotnet build "./Test-Case-Generator.csproj" -c $BUILD_CONFIGURATION -o /app/build

# Esta fase é usada para publicar o projeto de serviço a ser copiado para a fase final
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./Test-Case-Generator.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=true
...
ENTRYPOINT ["./Test-Case-Generator"]